...
export default function SaveModal(props: SaveModalProps) {
  ...
  return (
    <Dialog
      as="div"
      className="flex flex-row justify-center align-center z-50"
    ...
    >
      ...
      <div className="fixed inset-x-30 inset-y-20 flex items-center z-10 overflow-y-auto">
        <Dialog.Panel className="flex flex-col items-center w-full max-w-md py-6 px-10 transform overflow-hidden rounded-2xl bg-white bg-opacity-10 shadow-xl border dark:bg-opacity-90 dark:bg-slate-700 dark:border-white">
          ...
          >
            ...
            <div className="flex flex-row justify-center w-full">
              <button
                ...
                type="submit"
                className="w-1/3 m-2.5 p-2 rounded-xl dark:bg-slate-500 dark:hover:bg-slate-300 dark:text-white dark:hover:text-slate-800"
              >
                Save
              </button>
              <button
