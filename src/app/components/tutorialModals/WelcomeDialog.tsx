...
export default function WelcomeDialog({welcomeDialog, setWelcomeDialog, setApiEndpointDialog}: WelcomeDialogProps) {
      ...
      >
            <Dialog onClose={() => {}} >
                ...
                <div className='flex flex-col items-center justify-center z-10 overflow-y-auto'>
                    <Dialog.Panel
                        className='flex flex-col items-center justify-center border dark:border-white fixed inset-x-90 inset-y-60 w-full max-w-md py-6 px-10 transform overflow-hidden rounded-2xl bg-white bg-opacity-10 shadow-xl dark:bg-opacity-90 dark:bg-slate-700 shadow-xs shadow-secondary'
                        >
                        <Dialog.Title className='flex align-center text-3xl font-bold dark:text-white'>
                            Welcome to Vista!
                        </Dialog.Title>
                        <p
                            className='text-l dark:text-white flex align-center m-6 w-full text-xl text-center'
                        >
                           Looks like you&apos;re new, let&apos;s show you how to use this GraphQL schema visualizer tool!
                        </p>
