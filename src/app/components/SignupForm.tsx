...
export default function SignupForm(
  ...
  const userTakenMsg =
    'Email address is already in use, sign in or use a different one to sign up.'
  ...
  return (
    <>
      ...
      {usernameTaken && (
        <p className="block text-sm font-medium leading-6 text-red-700 text-center">
          {userTakenMsg}
        </p>
      )}
      {createdUsername && (
        <>
          <p className="block text-sm font-medium leading-6 text-green-600 text-center">
            {userCreatedMsg}
          </p>
          <p
            onClick={
