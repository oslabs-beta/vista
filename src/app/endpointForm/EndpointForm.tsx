...
import { getSchema } from '@/app/endpointForm/getSchema'
  ...
  return (
    <>
      <form
        ...
        action={handleSubmit}
        className="pt-5 pr-4 pl-4 flex items-center dark:bg-slate-800"
      >
          ...
          <Menu as="div" className="relative inline-block text-left">
            <div>
              ...
              <Menu.Button
                ...
                className="inline-flex w-full justify-center gap-x-1.5 border border-blue-500 rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset hover:bg-gray-200 dark:bg-slate-500 dark:border-white dark:hover:bg-slate-300"
              >
                {isLoggedIn ? (
                  ...
                  <img
                    src={image}
                    alt=""
                    className="inline-flex w-full justify-center gap-x-1.5 border-blue-500 rounded-sm w-6 h-6"
                  />
                ) : (
                  <svg
                  ...
                  {!isLoggedIn && (
                    <Menu.Item>
                      <button
                        ...
                        className="inline-flex r-2 w-56 hover:bg-slate-300"
                      >
                        {' '}
                  ...
                  <Menu.Item>
                    {isLoggedIn ? (
                      <button
                        ...
                        onClick={onSignOut}
                        className="inline-flex w-56 hover:bg-slate-300"
                      >
                        Sign Out
                      </button>
                    ) : (
