...
export default function QueryGenerator(QueryGeneratorProps: QueryGenerator) {
  const { childToParent, queryAsString, setIsSaveModalOpen } =
    QueryGeneratorProps
      ...
      <form>
        ...
        <div>
          ...
          >
            ...
            <svg
              className="w-6 h-6 bg-white text-blue-400 dark:bg-slate-500 dark:text-white dark:hover:text-slate-900"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
